          ...
          {mode === "signup" ? (
            <>
              <div className="mb-lg mt-md">
                <h2 className="font-bold font-headline-md text-headline-md text-primary mb-xs">
                  Noor Youth
                </h2>
              ...
              <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                <div className="space-y-xs">
                  ...
                  <div className="relative rounded-lg group form-glow">
                    <span className="absolute -translate-y-1/2 material-symbols-outlined left-sm top-1/2 text-outline">
                      person
                    </span>
                    <input
                      className="w-full transition-all duration-200 border rounded-lg pl-lg pr-md py-sm bg-surface-container-lowest border-outline-variant font-body-md text-body-md text-on-surface focus:outline-none focus:border-primary"
                      id="full_name"
                ...
                <div className="space-y-xs">
                  ...
                  <div className="relative rounded-lg group form-glow">
                    ...
                    <input
                      className="w-full transition-all duration-200 border rounded-lg pl-lg pr-lg py-sm bg-surface-container-lowest border-outline-variant font-body-md text-body-md text-on-surface focus:outline-none focus:border-primary"
                      id="password"
                      placeholder="••••••••"
                    ...
                    />
                    <button
                      className="absolute transition-colors -translate-y-1/2 right-sm top-1/2 text-outline hover:text-primary"
                      type="button"
              ...
              <div className="text-center border-t mt-sm pt-md border-outline-variant">
                <p className="font-body-md text-body-md text-on-surface-variant">
                  Already a member?
                  <button
                    className="font-bold transition-colors text-secondary hover:text-primary ml-xs"
            ...
            <>
              ...
              <form className="space-y-md" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-xs">
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      className="transition-colors font-body-sm text-body-sm text-primary hover:text-secondary-fixed-dim"
                      href="#"
                    >
                      Forgot password?
                    </a>
                  ...
                  <div className="relative rounded-lg form-glow">
                    ...
                    />
                    <button
                      className="absolute -translate-y-1/2 right-sm top-1/2 text-outline hover:text-on-surface-variant"
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                    >
                      <span className="material-symbols-outlined">
              ...
              <div className="mt-lg">
                <button className="flex items-center justify-center w-full transition-colors border rounded-lg gap-md py-sm px-md border-outline-variant hover:bg-surface-container-low font-button text-button text-on-surface">
              ...
              <p className="text-center mt-md mb-md font-body-md text-body-md text-on-surface-variant">
                ...
                <button
                  className="font-bold text-primary hover:underline decoration-secondary-fixed decoration-2 underline-offset-4 ml-xs"
